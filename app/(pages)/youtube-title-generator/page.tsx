...
export default function YouTubeTitleGeneratorPage() {
  ...
  const handleSubmit = async () => {
    if (status === "unauthenticated" || !session) {
      router.push(
        `/signup?callbackUrl=${encodeURIComponent(pathname || "/youtube-title-generator")}`,
      );
      return;
    }
    ...
    if (!prompt.trim()) {
      setError("Please enter your video topic or description.");
      return;
    }
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Enter your video topic or description to get click-worthy, SEO-friendly title ideas.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="e.g. How to learn Python in 30 days for beginners"
            value={prompt}
        ...
        {result && (
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">Title ideas</label>
